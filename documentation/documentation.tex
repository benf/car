...
\section{Fahrzeugschaltung} %% TODO
	...
	\subsection{Motoransteuerung}
		...
		%% TODO: Schaltbild des L298 + erklärung? kann ja gefragt sein in prüfung
		...
		PWM ist ein DA-Wandler bei dem die Genauigkeit eine untergeordnete Rolle spielt.
		...
		der hardwareseitig eine Zahl hochzählt. Dabei wird beispielsweise vor dem erreichen einer bestimmten (eingestellbaren) Zahl
		der Ausgang auf Low setzt und danach auf High. So entstehen unterschiedliche lange Impulse.
		Und das arithmetische variiert je nach eingestellter Zahl.
